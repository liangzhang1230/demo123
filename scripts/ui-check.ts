...
const DEFAULT_CHECKS: PageCheck[] = [
  ...
  { route: '/script', expects: ['演示脚本 · 商务 10 分钟动线', '提词', '一键点亮全家桶', '三条底线'] },
  {
    ...
    expects: [
      ...
      '招错一个人', '进入筛选详情页', '功能', '解决', '结果',
      // P12：新人筛选/筛人漏斗/周期漏斗联动/AI 参谋/日趋势/本月流失
      '想给高底薪招销冠', '李曼（新人）', '孙悦', '周舟', '天预警 · 数据落后', '筛人漏斗（转正窗口对比）',
      '陈昊', '韩雪', 'AI 参谋 · 归因 / 预测 / 建议', '日回款趋势', '本月流失原因', '点时口径，不随周期变',
    ],
  },
  {
    route: '/rookie',
    expects: ['新人筛选 · 详情页', '想给高底薪招销冠', '李强', `窗口 90 天`, '筛人漏斗（分层）', '留用（转正）', 'labor_roi', '李曼（新人）', '孙悦', '周舟', '陈昊', '韩雪', '天预警', '正向流转正序', '全员总排名', '销冠苗子'],
  },
  ...
  {
    route: '/manager',
    expects: ['刘敏（主管）· 销售一部', '区四 · 团队一屏（销售一部）', '主管版摘除购买位', '王丽', '刘敏早', '销售早报', '总成交转化率'],
    absents: ['试看申请', '系统投入产出参照', '部门筛选'],
  },
  {
    route: '/sales',
    expects: [
      ...
      '王丽早', '上线后由 AI 销售操盘手按你的真实数据每日生成', '成交流水',
      '我的转化率 · 成交率', '我的本月流失原因', 'AI 参谋 · 归因 / 预测 / 建议', '我的成交率',
    ],
