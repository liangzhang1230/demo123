  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  <div class="cv">
    ...
    <div class="content" style="left:78px;right:190px;top:60px;">
      ...
      <div class="support" style="font-size:15px;letter-spacing:1px;margin-bottom:18px;">483家倒闭公司尸检 · 产品不好仅占17%</div>
      <h1 style="font-size:66px;">创业死掉的，90%<br>不是<span class="r">产品</span>，是<span class="g">卖不动</span></h1>
    </div>
    ...
    <div class="content" style="left:120px;right:80px;top:150px;">
      ...
      <div class="support" style="font-size:24px;letter-spacing:1px;margin-bottom:34px;">483家倒闭公司尸检 · 产品不好仅占17%</div>
      <h1 style="font-size:112px;">创业死掉的，<br>90%不是<span class="r">产品</span>，<br>是<span class="g">卖不动</span></h1>
    </div>
...
(async () => {
  ...
  for (const [fmt,w,h,out] of [['h',900,383,'cover_cy_2.35x1.png'],['sq',1080,1080,'cover_cy_1x1.png']]) {
